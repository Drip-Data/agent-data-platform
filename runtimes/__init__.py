from .sandbox.runtime import LightweightSandboxRuntime, NSJailExecutor
...
def get_web_navigator_classes():
    ...
    try:
        from .web_navigator.runtime import MemoryControlledWebRuntime
        from .web_navigator.browser_manager import BrowserManager
