...
from core.toolscore.interfaces.toolscore_interfaces import ToolSpec, ExecutionResult, RegistrationResult, ToolCapability, ToolType, MCPServerSpec, FunctionToolSpec, ErrorType
