...
from core.toolscore.interfaces.toolscore_interfaces import (
...
class UnifiedToolLibrary:
    ...
    def __init__(self, mcp_client: Optional[Any] = None, redis_url: str = "redis://redis:6379", redis_manager=None):
        ...
        # 新增：MCP 服务器注册表
        from core.toolscore.mcp.mcp_connector import MCPServerRegistry
    ...
    async def initialize(self):
        ...
        try:
            ...
            # 初始化工具缺口检测器（简化版本）
            from core.toolscore.detection.tool_gap_detector import ToolGapDetector
            ...
            # 初始化MCP搜索工具
            from core.toolscore.detection.mcp_search_tool import MCPSearchTool
